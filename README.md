...
* 1 - melhor escolha do Framework : utilizamos NPM como gerenciador de pacotes do Node, porém existem Ferramentas mais atuais que facilitam o manejo, a integração e deploy da aplicação como Next/Vercel , Yarn ;
